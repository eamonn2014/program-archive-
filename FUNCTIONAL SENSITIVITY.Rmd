...
#### Program is provided which Fit 11 models to single predictor and use sum of square of residual as model selection criteria
...
func.sens <- function (x, y, model, spec, print.plot) {
...
```{r execute1, echo=FALSE, eval=FALSE}
...
###Execute2 made up data


****************** 

```{r execute2, echo=FALSE, eval=FALSE}
...
####Execute 3rd analysis, real functional sensitivity data

****************** 

```{r real data , echo=FALSE, eval=FALSE}
...
####Data from Olaide Merck's IGF

****************** 

```{r GUSBCVData, echo=FALSE, eval=TRUE} 
mu<-c(
38.51102 ,
 39.18610 ,
38.45812 ,
...
for (j in 1:11) {
  func.sens(x=mu, y=cv, model=j, spec=2.5) 
}
